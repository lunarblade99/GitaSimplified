...
public class Vchp7 extends AppCompatActivity
    ...
    private View.OnClickListener onItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if(position == 0) {
                Toast.makeText(Vchp7.this, "You Clicked: " + thisItem.getTitle(), Toast.LENGTH_SHORT).show();
            }
            if(position == 1) {
                Toast.makeText(Vchp7.this, "You Clicked: " + thisItem.getTitle(), Toast.LENGTH_SHORT).show();
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
        ...
        mData.add(new NewsItem("","","jñānaṁ te ’haṁ sa-vijñānam idaṁ vakṣhyāmyaśheṣhataḥ\n" + "yaj jñātvā neha bhūyo ’nyaj jñātavyam-avaśhiṣhyate",R.color.trans));
        mData.add(new NewsItem("","","manuṣhyāṇāṁ sahasreṣhu kaśhchid yatati siddhaye\n" + "yatatām api siddhānāṁ kaśhchin māṁ vetti tattvataḥ",R.color.trans));
        mData.add(new NewsItem("","","bhūmir-āpo ’nalo vāyuḥ khaṁ mano buddhir eva cha\n" + "ahankāra itīyaṁ me bhinnā prakṛitir aṣhṭadhā",R.color.trans));
        mData.add(new NewsItem("","","apareyam itas tvanyāṁ prakṛitiṁ viddhi me parām\n" + "jīva-bhūtāṁ mahā-bāho yayedaṁ dhāryate jagat",R.color.trans));
        mData.add(new NewsItem("","","etad-yonīni bhūtāni sarvāṇītyupadhāraya\n" + "ahaṁ kṛitsnasya jagataḥ prabhavaḥ pralayas tathā",R.color.trans));
        mData.add(new NewsItem("","","mattaḥ parataraṁ nānyat kiñchid asti dhanañjaya\n" + "mayi sarvam idaṁ protaṁ sūtre maṇi-gaṇā iva",R.color.trans));
        mData.add(new NewsItem("","","raso ’ham apsu kaunteya prabhāsmi śhaśhi-sūryayoḥ\n" + "praṇavaḥ sarva-vedeṣhu śhabdaḥ khe pauruṣhaṁ nṛiṣhu",R.color.trans));
        mData.add(new NewsItem("","","puṇyo gandhaḥ pṛithivyāṁ cha tejaśh chāsmi vibhāvasau\n" + "jīvanaṁ sarva-bhūteṣhu tapaśh chāsmi tapasviṣhu",R.color.trans));
        mData.add(new NewsItem("","","bījaṁ māṁ sarva-bhūtānāṁ viddhi pārtha sanātanam\n" + "buddhir buddhimatām asmi tejas tejasvinām aham",R.color.trans));
        mData.add(new NewsItem("","","balaṁ balavatāṁ chāhaṁ kāma-rāga-vivarjitam\n" + "dharmāviruddho bhūteṣhu kāmo ’smi bharatarṣhabha",R.color.trans));
        mData.add(new NewsItem("","","ye chaiva sāttvikā bhāvā rājasās tāmasāśh cha ye\n" + "matta eveti tān viddhi na tvahaṁ teṣhu te mayi",R.color.trans));
        mData.add(new NewsItem("","","tribhir guṇa-mayair bhāvair ebhiḥ sarvam idaṁ jagat\n" + "mohitaṁ nābhijānāti māmebhyaḥ param avyayam",R.color.trans));
        mData.add(new NewsItem("","","daivī hyeṣhā guṇa-mayī mama māyā duratyayā\n" + "mām eva ye prapadyante māyām etāṁ taranti te",R.color.trans));
        mData.add(new NewsItem("","","na māṁ duṣhkṛitino mūḍhāḥ prapadyante narādhamāḥ\n" + "māyayāpahṛita-jñānā āsuraṁ bhāvam āśhritāḥ",R.color.trans));
        mData.add(new NewsItem("","","chatur-vidhā bhajante māṁ janāḥ sukṛitino ’rjuna\n" + "ārto jijñāsur arthārthī jñānī cha bharatarṣhabha",R.color.trans));
        mData.add(new NewsItem("","","teṣhāṁ jñānī nitya-yukta eka-bhaktir viśhiṣhyate\n" + "priyo hi jñānino ’tyartham ahaṁ sa cha mama priyaḥ",R.color.trans));
        mData.add(new NewsItem("","","udārāḥ sarva evaite jñānī tvātmaiva me matam\n" + "āsthitaḥ sa hi yuktātmā mām evānuttamāṁ gatim",R.color.trans));
        mData.add(new NewsItem("","","bahūnāṁ janmanām ante jñānavān māṁ prapadyate\n" + "vāsudevaḥ sarvam iti sa mahātmā su-durlabhaḥ",R.color.trans));
        mData.add(new NewsItem("","","kāmais tais tair hṛita-jñānāḥ prapadyante ’nya-devatāḥ\n" + "taṁ taṁ niyamam āsthāya prakṛityā niyatāḥ svayā",R.color.trans));
        mData.add(new NewsItem("","","yo yo yāṁ yāṁ tanuṁ bhaktaḥ śhraddhayārchitum ichchhati\n" + "tasya tasyāchalāṁ śhraddhāṁ tām eva vidadhāmyaham",R.color.trans));
        mData.add(new NewsItem("","","sa tayā śhraddhayā yuktas tasyārādhanam īhate\n" + "labhate cha tataḥ kāmān mayaiva vihitān hi tān",R.color.trans));
        mData.add(new NewsItem("","","antavat tu phalaṁ teṣhāṁ tad bhavatyalpa-medhasām\n" + "devān deva-yajo yānti mad-bhaktā yānti mām api",R.color.trans));
        mData.add(new NewsItem("","","avyaktaṁ vyaktim āpannaṁ manyante mām abuddhayaḥ\n" + "paraṁ bhāvam ajānanto mamāvyayam anuttamam",R.color.trans));
        mData.add(new NewsItem("","","nāhaṁ prakāśhaḥ sarvasya yoga-māyā-samāvṛitaḥ\n" + "mūḍho ’yaṁ nābhijānāti loko mām ajam avyayam",R.color.trans));
        mData.add(new NewsItem("","","vedāhaṁ samatītāni vartamānāni chārjuna\n" + "bhaviṣhyāṇi cha bhūtāni māṁ tu veda na kaśhchana",R.color.trans));
        mData.add(new NewsItem("","","ichchhā-dveṣha-samutthena dvandva-mohena bhārata\n" + "sarva-bhūtāni sammohaṁ sarge yānti parantapa",R.color.trans));
        mData.add(new NewsItem("","","yeṣhāṁ tvanta-gataṁ pāpaṁ janānāṁ puṇya-karmaṇām\n" + "te dvandva-moha-nirmuktā bhajante māṁ dṛiḍha-vratāḥ",R.color.trans));
        mData.add(new NewsItem("","","jarā-maraṇa-mokṣhāya mām āśhritya yatanti ye\n" + "te brahma tadviduḥ kṛitsnam adhyātmaṁ karma chākhilam",R.color.trans));
        mData.add(new NewsItem("","","sādhibhūtādhidaivaṁ māṁ sādhiyajñaṁ cha ye viduḥ\n" + "prayāṇa-kāle ’pi cha māṁ te vidur yukta-chetasaḥ",R.color.trans));

...
public class vchp1 extends AppCompatActivity
    ...
    private View.OnClickListener onItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if(position == 0) {
                Toast.makeText(vchp1.this, "You Clicked: " + thisItem.getTitle(), Toast.LENGTH_SHORT).show();
            }
            if(position == 1) {
                Toast.makeText(vchp1.this, "You Clicked: " + thisItem.getTitle(), Toast.LENGTH_SHORT).show();
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.meaning){
            Intent myIntent = new Intent(this, vchp1.class);

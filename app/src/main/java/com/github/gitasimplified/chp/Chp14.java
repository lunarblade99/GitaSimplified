...
public class Chp14 extends AppCompatActivity
    ...
    private View.OnClickListener onItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if(position == 0) {
                Toast.makeText(Chp14.this, "You Clicked: " + thisItem.getTitle(), Toast.LENGTH_SHORT).show();
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mData.add(new NewsItem("I 14 Programming And Design","Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,","6 july 1994",R.drawable.circul6));
